...
namespace ASPNetCore.Controllers
{
    public class EvaluacionController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AlumnoId,AsignaturaId,Calificacion,Id,Nombre")] Evaluacion evaluacion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("AlumnoId,AsignaturaId,Calificacion,Id,Nombre")] Evaluacion evaluacion)
        {
            if (id != evaluacion.Id)
            {
                return NotFound();
